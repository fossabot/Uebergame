...
function Lab::initLabMenuData(%this,%buildAfter) {
	...
	%subId=-1;
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "at Origin" TAB "" TAB "EWorldEditor.dropttype = \"atOrigin\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "at Camera" TAB "" TAB "EWorldEditor.dropttype = \"atCamera";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "at Camera w/Rotation" TAB "" TAB "EWorldEditor.dropttype = \"atCameraRot\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "Below Camera" TAB "" TAB "EWorldEditor.dropttype = \"belowCamera\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "Screen Center" TAB "" TAB "EWorldEditor.dropttype = \"screenCenter\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "at Centroid" TAB "" TAB "EWorldEditor.dropttype = \"atCentroid\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "to Terrain" TAB "" TAB "EWorldEditor.dropttype = \"toTerrain\"";
	$LabMenuSubMenuItem[%id,%itemId,%subId++] = "Below Selection" TAB "" TAB "EWorldEditor.dropttype = \"belowSelection\"";
	$LabMenuItem[%id,%itemId++] = "-";
