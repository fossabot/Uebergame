...
//==============================================================================
// Torque3D Default Client/Server Messaging System
//==============================================================================
//-----------------------------------------------------------------------------
...
function checkCallback(%msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10)
{
   for (%i = 0; (%func = $MSGCB["", %i]) !$= ""; %i++) {
      call(%func, %msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10);
   } 
}
function checkTaggedCallback(%tag,%msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10)
{
...
function clientCmdServerMessage(%msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10)
{
   ...
   checkCallback(%msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10);  

   // Next look for a callback for this particular type of ServerMessage.
   if (%tag !$= "")
       checkTaggedCallback(%tag,%msgType, %msgString, %a1, %a2, %a3, %a4, %a5, %a6, %a7, %a8, %a9, %a10);   
...
//messageClient(LocalClientConnection, 'MsgLoadFailed', '\c0You picked up %1', %this.pickupName);
// This just invokes onServerMessage, which can be overridden by the game
function onServerMessage(%msgString,%a, %b, %c, %d, %e, %f, %g, %h, %i)
{
   onGameMessage(%msgString);
